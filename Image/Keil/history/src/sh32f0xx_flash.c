...
//#define ACR_CFG_Set               ((uint32_t)0x000cc103<<12)
//#define ACR_CFG_Reset              ((uint32_t)0x00000FFF)
//#define ACR_1K_Set                ((uint32_t)0x00000001<<10)
//#define ACR_SYSSEL_Set                ((uint32_t)0x00000001<<11)
//#define ACR_SYSER_Set               ((uint32_t)0x0000A5BA<<16)
//#define ACR_1K_Reset               ((uint32_t)0xFFFFFBFF)
//#define ACR_SYSSEL_Reset               ((uint32_t)0xFFFFF7FF)
//#define ACR_SYSER_Reset               ((uint32_t)0x0000FFFF)
//#define CR_OPTER_Reset           ((uint32_t)0x00001FDF)
//#define CR_STRT_Set              ((uint32_t)0x00000040)
//#define CR_LOCK_Set              ((uint32_t)0x00000080)
//
//  
//#define KEY0_Set               ((uint32_t)0x1234)
//#define KEY0_Reset               ((uint32_t)0x0000)
//#define KEY1_Set               ((uint32_t)0x4321)
//#define KEY1_Reset               ((uint32_t)0x000)
//
///* FLASH Mask */
...
//
//
//FLASH_Status FLASH_EraseNvr_opt(uint32_t Page_Address)
//{
...
//    FLASH->ACR |= ACR_CFG_Set;
//    FLASH->ACR &= ACR_1K_Reset;
...
//      FLASH->ACR |= ACR_1K_Set;
//      FLASH->ACR &= ACR_CFG_Reset;
//    }
//    else
//    {
...
//
//
//FLASH_Status FLASH_EraseNvr_sys(uint32_t Page_Address)
//{
//  FLASH_Status status = FLASH_COMPLETE;
//  
//  /* Wait for last operation to be completed */
...
//    //FLASH->OPTKEYR = FLASH_KEY2;
//    /* if the previous operation is completed, proceed to erase the option bytes */
//    //FLASH->ACR |= ACR_SYSSEL_Set;
//    //FLASH->ACR |= ACR_CFG_Set;
//    FLASH->CR |= ACR_SYSER_Set;
//    FLASH->CR |= CR_OPTER_Set;
//    FLASH->AR = Page_Address; 
//    FLASH->CR |= CR_STRT_Set;
//    /* Wait for last operation to be completed */
...
//      /* if the erase operation is completed, disable the OPTER Bit */
//      FLASH->CR &= CR_OPTER_Reset;
//      FLASH->CR &= ACR_SYSER_Reset;
//      //FLASH->ACR &= ACR_SYSSEL_Reset;
//      //FLASH->ACR &= ACR_CFG_Reset;
//    }
//    else
//    {
...
//
//
//FLASH_Status FLASH_EraseNvr_sec(uint32_t Page_Address)
//{
//  FLASH_Status status = FLASH_COMPLETE;
//  
//  /* Wait for last operation to be completed */
...
//    {
//      /* if the erase operation is completed, disable the OPTER Bit */
//      //FLASH->KEY0 = KEY0_Reset;
//      //FLASH->KEY1 = KEY1_Reset;
//      FLASH->CR &= CR_OPTER_Reset;
//    }
//    else
//    {
...
//    }  
//  }
//  //print_led("security erase end!\n");
//  /* Return the erase status */
//  return status;
//}
//
//
//FLASH_Status FLASH_EraseNvr_pro(uint32_t Page_Address)
//{
//  FLASH_Status status = FLASH_COMPLETE;
//  
//  /* Wait for last operation to be completed */
...
//}
//
//FLASH_Status FLASH_ProgramNvr_opt(uint32_t Address, uint16_t Data)
//{
//  FLASH_Status status = FLASH_COMPLETE;
//  /* Check the parameters */
...
//}
//
//FLASH_Status FLASH_ProgramNvr_sys(uint32_t Address, uint16_t Data)
//{
//  FLASH_Status status = FLASH_COMPLETE;
//  /* Check the parameters */
//  assert_param(IS_OB_DATA_ADDRESS(Address));
...
//}
//
//FLASH_Status FLASH_ProgramNvr_pro(uint32_t Address, uint16_t Data)
//{
//  FLASH_Status status = FLASH_COMPLETE;
//  /* Check the parameters */
//  assert_param(IS_OB_DATA_ADDRESS(Address));
...
//}
//
//FLASH_Status FLASH_secret_key_set(uint32_t Address,uint16_t key)
//{
//  FLASH_Status status = FLASH_COMPLETE;
//  /* Check the parameters */
//  assert_param(IS_OB_DATA_ADDRESS(Address));
...
//    FLASH->OPTKEYR = FLASH_KEY1;
//    FLASH->OPTKEYR = FLASH_KEY2;
//    FLASH->KEY0 = 0xFFFFFFFF;
//    FLASH->KEY1 = 0xFFFFFFFF;
//    /* Enables the Option Bytes Programming operation */
//    FLASH->CR |= CR_OPTPG_Set; 
//    *(__IO uint16_t*)Address = key;
//    
//    /* Wait for last operation to be completed */
//    status = FLASH_WaitForLastOperation(ProgramTimeout);
//    if(status != FLASH_BUSY)
...
//
//
//FLASH_Status FLASH_ProgramNvr_sec(uint32_t Address, uint16_t Data)
//{
//  FLASH_Status status = FLASH_COMPLETE;
//  /* Check the parameters */
//  assert_param(IS_OB_DATA_ADDRESS(Address));
...
//}
//
//void set_sec_key(uint16_t key0,uint16_t key1)
//{
//    FLASH->KEY0 = key0;
//    FLASH->KEY1 = key1;
//}
//
//FLASH_Status FLASH_ProgramSystemHalfWord(uint32_t Address, uint16_t Data)
//{
//  FLASH_Status status = FLASH_COMPLETE;
//  /* Check the parameters */
//  assert_param(IS_FLASH_ADDRESS(Address));
